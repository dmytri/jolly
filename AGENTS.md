...
`homepage/index.html` and `homepage/setup.md` are derived implementation output. They may be regenerated by Crew and are not the source of truth for approved homepage or setup-guide content; `homepage/setup.md` derives from `assets/homepage/setup.md` (see feature 016).
