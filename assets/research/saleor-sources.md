# Saleor source repositories and integration boundaries

Research notes on the upstream sources Jolly delegates to. Reference material, not
requirements: binding behaviour lives in `features/**`. Moved out of a feature file
2026-07-22, where the three scenarios it carried were already asserted by feature 002
(Paper baseline), feature 004 (configurator command), and feature 006 (spawned-tool
allowlist).

## `saleor/storefront` research notes
...
## `saleor/configurator` research notes
...
## `saleor/agent-skills` research notes
...
## Deprecated `saleor/cli` research notes
