...
- budget: 1200 — full-regression wall-clock ceiling in seconds, dk-ruled; the derived budget check in feature `verification-economy` reads each tier's weather record and reddens on breach. The 10-minute target below this ceiling is reachable only by running tiers concurrently, a hardware decision, not a methodology one.
- budget-logic: 210
- budget-sandbox: 210
- budget-sandbox-serial: 540
- budget-eval: 240
